  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: new ListView(
          children: <Widget>[
            new ListBr(
              gambar: "images/bangun_ruang/kubus.jpg",
              judul: "Kubus",
              alamat: '/kubus',
            ),
            new ListBr(
                gambar: "images/bangun_ruang/balok.jpg",
                judul: "Balok",
                alamat: '/balok'),
            new ListBr(
              gambar: "images/bangun_ruang/limas.jpg",
              judul: "Limas",
              alamat: '/limas',
            ),
            new ListBr(
              gambar: "images/bangun_ruang/prisma.png",
              judul: "Prisma",
              alamat: '/prisma',
            ),
            new ListBr(
              gambar: "images/bangun_ruang/tabung.jpg",
              judul: "Tabung",
              alamat: '/tabung',
            ),
            new ListBr(
              gambar: "images/bangun_ruang/kerucut.jpg",
              judul: "Kerucut",
              alamat: '/kerucut',
            ),
            new ListBr(
              gambar: "images/bangun_ruang/bola.jpg",
              judul: "Bola",
              alamat: '/bola',
            )
          ],
