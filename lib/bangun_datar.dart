  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: new ListView(
          children: <Widget>[
            new ListBd(
              gambar: "images/bangun_datar/persegi.png",
              judul: "Persegi",
              alamat: "/persegi",
            ),
            new ListBd(
              gambar: "images/bangun_datar/persegi_panjang.png",
              judul: "Pesegi Panjang",
              alamat: "/persegiPanjang",
            ),
            new ListBd(
              gambar: "images/bangun_datar/segitiga.png",
              judul: "Segitiga",
              alamat: "/segitiga",
            ),
            new ListBd(
              gambar: "images/bangun_datar/jajargenjang.jpg",
              judul: "Jajar Genjang",
              alamat: '/jajargenjang',
            ),
            new ListBd(
              gambar: "images/bangun_datar/trapesium.png",
              judul: "Trapesium",
              alamat: "/trapesium",
            ),
            new ListBd(
              gambar: "images/bangun_datar/layanglayang.png",
              judul: "Layang-Layang",
              alamat: "/layanglayang",
            ),
            new ListBd(
              gambar: "images/bangun_datar/belahketupat.png",
              judul: "Belah Ketupat",
              alamat: "/belahketupat",
            ),
            new ListBd(
              gambar: "images/bangun_datar/lingkaran.png",
              judul: "Lingkaran",
              alamat: "/lingkaran",
            ),
          ],
